...
<body>
    <!-- Preloader start -->
    <div id="preloader">
        <!-- Preloader content can be added here if needed -->
    </div>
    <!-- Preloader end -->
        ...
        <div class="nav-header">
            <a href="#" class="brand-logo">
                <svg xmlns="http://www.w3.org/2000/svg" width="175" height="175" viewBox="0 0 110 120">
                    <image href="images/LogoSinarmas VMS.png" x="0" y="0" width="110" height="120" />
                </svg>
            </a>
        ...
        <div class="chatbox">
            ...
            <div class="custom-tab-1">
                <div class="tab-content">
                    <!-- Chat box content can be added here if needed -->
                </div>
            </div>
        </div>
        <!-- Chat box end -->
                            ...
                            <li class="nav-item dropdown header-profile" style="align-content:center;">
                                <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                                    ...
                                    <div class="d-inline-block align-middle" style="color: black">
                                        ...
                                        <div style="font-size: 12px; color: grey;">Admin Account</div>
                                    </div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end" style="width:350px">
                                    <div class="text-center py-3 border-bottom">
                                        <img src="images/profile/pic1.jpg" width="80" height="80" class="rounded-circle" alt="Profile Picture">
                                        <h5 class="font-w600 mt-3">{{ Auth::guard('admin')->user()->username }}</h5>
                                    </div>
                                    <div class="row">
                                        <div class="col text-end">
                                            <a href="{{ route('profile_admin.show') }}" class="dropdown-item ai-icon">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a href="berandaadmin" class="ai-icon" aria-expanded="false">
                        <i class="flaticon-025-dashboard"></i>
                        <span class="nav-text">Dashboard</span>
                    </a></li>
                    <li><a href="hostadmin" class="ai-icon" aria-expanded="false">
                        <i class="fa-solid fa-user-check"></i>
                        <span class="nav-text">Host</span>
                    </a></li>
                    <li><a href="divisi" class="ai-icon" aria-expanded="false">
                        <i class="fa-solid fa-layer-group"></i>
                        <span class="nav-text">Divisi</span>
                    </a></li>
                    <li><a href="lokasi_admin" class="ai-icon" aria-expanded="false">
                        <i class="fa-solid fa-location-dot"></i>
                        <span class="nav-text">Lokasi</span>
                    </a></li>
                    <li><a href="riwayat_admin" class="ai-icon" aria-expanded="false">
                        <i class="fa-solid fa-clock-rotate-left"></i>
                        <span class="nav-text">Riwayat</span>
                    </a></li>
                    <li><a href="informasi_tamu" class="ai-icon" aria-expanded="false">
    ...
    <!-- SweetAlert script for success messages -->
