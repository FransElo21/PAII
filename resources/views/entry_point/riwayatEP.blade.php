...
<div class="col-lg-12">
    <div class="card">
        <div class="card-header">
            <h1 class="card-title" style="font-size: 45px;">Riwayat</h1>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <div class="row mb-3">
                    <div class="d-flex align-items-end justify-content-end">
                        ...
                        <select id="statusFilter" class="form-select custom-red select-custom me-2 ms-auto" aria-label="Filter" style="background-color:#40A752; color:#FFFF;">
                            <option value="">Status</option>
                            <option value="ditolak">Ditolak</option>
                            <option value="kadaluarsa">Kadaluarsa</option>
                            <option value="selesai">Selesai</option>
                        </select>
                        <a href="{{ route('riwayat.cetak2') }}" class="btn btn-primary btn-custom me-2" target="_blank" style="background-color: #828282;
                         border-color: #828282;">
                            <i class="fas fa-print"></i> Cetak
                        </a>
                        <input type="date" id="tanggalFilter" class="form-control input-custom" style="margin: 0; background-color:#40A752; color:#FFFF">
                    </div> 
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title" id="undanganDetailModalLabel{{ $item->id }}"><b>Riwayat</b></h3>
