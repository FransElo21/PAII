    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                <div class="card-header">{{ __('Entry Point Profile') }}</div>
                <div class="card-body">
                    <div class="profile-container">
                        ...
                        <div class="profile-details">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control-plaintext" name="name" value="{{ $Entry->nama }}" readonly>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="username" class="col-md-4 col-form-label text-md-right">{{ __('Username') }}</label>
                                <div class="col-md-6">
                                    <input id="username" type="text" class="form-control-plaintext" name="username" value="{{ $Entry->username }}" readonly>
                                </div>
                            </div>
                        </div>
                    </div>
