                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="dropdown header-profile" style=" align-content:center;">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<span class="font-w600">
									@if(Auth::user()->foto_profil)
										<img src="{{ asset(Auth::user()->foto_profil) }}" width="40" height="40" class="rounded-circle align-middle" alt="Foto Profil">
									@endif
										<small class="text-end font-w700"><b>{{ Auth::user()->username }}</b></small>
									</span>
								</a>								
								<div class="dropdown-menu dropdown-menu-end">
        ...
        <div class="dlabnav">
            <div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
                    <li><a href="beranda" class="ai-icon" aria-expanded="false">
							<i class="flaticon-025-dashboard"></i>
							<span class="nav-text">Dashboard</span>
						</a>
					</li>
                    <li><a href="riwayat" class="ai-icon" aria-expanded="false">
							<i class="fa-solid fa-clock-rotate-left"></i>
							<span class="nav-text">Riwayat</span>
						</a>
					</li>
					<li><a href="host" class="ai-icon" aria-expanded="false">
						<i class="fa-solid fa-user-check"></i>
						<span class="nav-text">Host</span>
					</a>
					</li>
					<li><a href="kunjungan" class="ai-icon" aria-expanded="false">
						<i class="flaticon-022-copy"></i>
						<span class="nav-text">Kunjungan</span>
					</a>
					<li><a href="lokasi" class="ai-icon" aria-expanded="false">
